...
function cryout_customizer_enqueue_scripts() {
	wp_enqueue_style( 'cryout-customizer-css', esc_url( get_template_directory_uri() ) . '/admin/css/customizer.css', array(), _CRYOUT_THEME_VERSION );
	//wp_enqueue_script( 'cryout-customizer-js', esc_url( get_template_directory_uri() ) . '/admin/js/customizer.js', array( 'jquery' ), _CRYOUT_THEME_VERSION, true );
}
